...
class BetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bet" do
    assert_difference("Bet.count") do
      post bets_url, params: { bet: { points: @bet.points, race_id: @bet.race_id, user_id: @bet.user_id } }
    end
  ...
  test "should update bet" do
    patch bet_url(@bet), params: { bet: { points: @bet.points, race_id: @bet.race_id, user_id: @bet.user_id } }
