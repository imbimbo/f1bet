...
class RacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race" do
    assert_difference("Race.count") do
      post races_url, params: { race: { date: @race.date, name: @race.name, race_type: @race.race_type } }
    end
  ...
  test "should update race" do
    patch race_url(@race), params: { race: { date: @race.date, name: @race.name, race_type: @race.race_type } }
